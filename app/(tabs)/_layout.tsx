...
export default function TabLayout() {
  ...
  const visibleNavItems = navItems.filter((item) => item.path === '/approvals' ? canApprove : ['/operations', '/fleet', '/reports'].includes(item.path) ? canAdmin : true);
