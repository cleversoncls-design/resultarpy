...
export default function RootLayout() {
  ...
  const standaloneRoutes = ['/new-trip', '/expenses', '/fleet-reservation', '/maintenance-report', '/new-vehicle', '/new-work-order', '/fleet-cadastros', '/general-cadastros', '/cadastro-detalhe', '/closure-queue', '/admin-users', '/trip-detail', '/administrativo', '/aprovador', '/viajante'];
